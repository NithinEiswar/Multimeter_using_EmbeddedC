...
int main(void)
{
  int Vin = 5;
  float Vout = 0;
  float R1 = 56000; //Resistance of R1=56000 ohms
  float R2 = 0; //Resistance of R2(unknown)
  float buffer1 = 0;
  int x = 0;
  int n=0;
  ADC_START();
  ...
  while (1)
  {
    ...
    { send_string("");
      ...
      send_string("R2=");
      String stringVal = "";
      stringVal += String(int(R2)) + "." + String(getDecimal(R2)); //combining both whole and decimal part in string with a fullstop between them
